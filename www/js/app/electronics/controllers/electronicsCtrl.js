...
['$scope', '$state', '$stateParams', '$rootScope', '$ionicScrollDelegate', 'electronicsService',
	function ($scope, $state, $stateParams, $rootScope, $ionicScrollDelegate, electronicsService) {
	        ...
	        electronicsService.getProductDataBySearch().get(form).$promise.then(
                function (response) {
                    ...
                    if (response.data.length > 0) {
                        $scope.noResult = false;
                        var metaTitle = 'Online Shopping Hub | Electronics ' + $stateParams.title;
