...
['$scope', '$state', '$stateParams', '$rootScope', '$ionicScrollDelegate', 'watchesCategoryService',
	function ($scope, $state, $stateParams, $rootScope, $ionicScrollDelegate, watchesCategoryService) {
