...
angular.module('mainApp').controller('watchesProductCtrl',
['$scope', '$state', '$stateParams', '$sce', '$window', '$ionicHistory', '$ionicModal', '$ionicSlideBoxDelegate', 'watchesService',
	function ($scope, $state, $stateParams, $sce, $window, $ionicHistory, $ionicModal, $ionicSlideBoxDelegate, watchesService) {

	    // LOAD PRODUCT
	    // =============================================================================
	    var loadProduct = function () {
	        watchesService.getProductById().get({ 'id': $stateParams.id }).$promise.then(
                function (response) {
                    // success
                    if (response.data.length > 0) {
                        ...
                        var adsIframePartOne = '//ws-na.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&MarketPlace=US&Operation=GetAdHtml&TemplateId=SrchWdgt&region=US&marketplace=amazon&tracking_id=onlshohub-20&auto_complete=true&search_type=search_widget&link_id=4WWPIWN6DDI7PSL5&width=1186&height=390&default_search_category=Watches&default_search_key=';
